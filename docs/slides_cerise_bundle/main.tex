...
\item \textbf{LAFusion}: não reporta só o ganho de +23,7\% pontual; mede também a degradação de $-$12,7\% contínua e explica a reversão com teoria prévia de filtragem sob observação intermitente.
\end{itemize}

\vspace{0.2cm}
\textbf{Contribuições:} (1) gêmeo digital câmera+YOLO validado (mAP@0,5=0,995, erro 4,7 cm), base comum aos dois trabalhos; (2) diagnóstico causal de por que PPO perde em MRTA com $N=3$, isolando o espaço de ação pequeno como fator dominante; (3) caracterização dupla do EKF sob cobertura esparsa, com a reversão de sinal explicada por teoria prévia, não apenas observada.
\end{frame}
...
\centering
\includegraphics[width=0.62\textwidth]{figures/lafusion_trajectory.png}
